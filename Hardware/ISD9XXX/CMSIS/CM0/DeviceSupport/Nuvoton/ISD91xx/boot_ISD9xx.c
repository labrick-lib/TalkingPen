...
__attribute__ ((section("vectors"))) = {
  (vect_t)(0x20003000),     // Top of Stack 
  (vect_t)Reset_Handler,    // Reset Handler
  (vect_t)int_test,      // NMI Handler
  (vect_t)int_test,// Hard Fault Handler
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,      // SVCall Handler
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,                        // Reserved
  (vect_t)int_test,   // PendSV Handler
  (vect_t)int_test,  // SysTick Handler
